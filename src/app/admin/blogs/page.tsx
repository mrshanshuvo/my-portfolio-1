...
export default function AdminBlogsPage() {
  ...
  async function handleSave() {
    ...
    setSaving(false);
    if (res.ok) showToast("Blogs saved!");
  ...
  function addTag(i: number) {
    ...
    updateBlog(i, "tags", [...currentTags, tag]);
        ...
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-slate-400">
              Manage your technical articles and thought leadership.
            </p>
          </div>
          <Button
            onClick={handleSave}
        ...
        <Card className="rounded-3xl border border-white/10 bg-slate-900/40 backdrop-blur-xl overflow-hidden">
          <CardHeader className="pb-4">
            <div className="flex items-center justify-between">
              ...
              >
                <FaPlus size={12} className="mr-2" /> Add Article
              </Button>
            </div>
          </CardHeader>
